...
const About: React.FC = () => {
  return (
    <div className="bg-[#1B1B1B] py-5 px-10 md:px-24 lg:px-44">
      <h2 className="text-white text-center font-semibold text-lg mb-5 md:mb-6 md:text-3xl">
        About Us
      </h2>
      <div>
        {aboutArray.map((item, index) => (
          ...
          >
            <div className="md:w-[40%]">
              ...
              />
              <p className="md:text-yellow-300 italic mt-2 font-thin text-sm font-serif text-center md:text-left">
                {item.name}
              </p>
            </div>
            <div className="mt-8 md:w-[60%]">
              <h2 className="text-yellow-300 text-center mb-4 text-lg font-bold md:text-xl lg:text-3xl">
                {item.title}
              </h2>
